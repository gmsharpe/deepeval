...
- [Response Monitoring](/confident-ai/confident-ai-llm-monitoring)
- [Online Evaluations](/confident-ai/confident-ai-llm-monitoring-evaluations)
- [LLM Tracing](/confident-ai/confident-ai-tracing)
- [Integrating Human Feedback](/confident-ai/confident-ai-human-feedback)
- [Placing Guardrails](/confident-ai/confident-ai-guardrails)
...
:::info
[Visit this section](/confident-ai/confident-ai-llm-monitoring) to learn more about leveraging the full capabilities of `deepeval.monitor`.
:::
...
:::tip  
No matter how you built your application—whether using another framework or from scratch—you can create **custom (and even hybrid) traces** in DeepEval. Explore this [complete guide to LLM Tracing](/confident-ai/confident-ai-tracing) to learn how to set it up.  
:::
